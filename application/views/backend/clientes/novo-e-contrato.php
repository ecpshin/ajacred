                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="valor-total" id="valor-total" data-allow-zeros="true" data-affixes-stay="true" 
                                                       data-prefix="R$ " data-thousands="." data-decimal="," class="form-control form-control-sm valor" 
                                                       value="<?= set_value('valor-total', 0.0) ?>" placeholder="0,00">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- /.form-row -->
                                    <div class="form-row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="valor-parcela" name="valor-parcela" data-allow-zeros="true" data-prefix="R$ "
                                                       data-affixes-stay="true" data-thousands="." data-decimal="," class="form-control form-control-sm valor" 
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="valor-liquido" name="valor-liquido" data-allow-zeros="true" data-prefix="R$ "
                                                       data-affixes-stay="true" data-thousands="." data-decimal="," class="form-control form-control-sm valor" 
                                        ...
                                        <div class="form-row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="valor-percentual" name="valor-percentual" data-allow-zeros="true" 
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" id="valor-comissao" name="valor-comissao" class="form-control form-control-sm valor" 
