                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <table class="table table-striped table-bordered">
                                            ...
                                            <tbody>
                                                <?php $id=1; foreach ($orgaos as $cliente) { ?>
                                                <tr>
                                                    <td style="vertical-align: middle; font-weight: bold">#<?=$id++?></td>
                                                    <td style="vertical-align: middle"><?=$cliente->nome_orgao ?></td>
                                                    <td style="vertical-align: middle"><?=$cliente->tipo_orgao?></td>
                                                    <td style="vertical-align: middle">ID: <?=$cliente->id_orgao?></td>
                                                    <td style="text-align: right; width: 150px; vertical-align: middle">
                                                        <a href="<?=base_url('cliente/ficha/'.sha1($cliente->id_orgao))?>" role="button" class="btn btn-primary" title="Ficha">
                                                            <i class="far fa-file-alt"></i>                                                            
                                                        </a>
                                                        <a href="<?=base_url('cliente/editar/'.sha1($cliente->id_orgao))?>" role="button" class="btn btn-warning" title="Editar">
                                                            <i class="fas fa-user-edit"></i>                                                            
                                                        </a>
                                                        <a href="<?=base_url('cliente/delete/')?>" role="button" class="btn btn-danger">
