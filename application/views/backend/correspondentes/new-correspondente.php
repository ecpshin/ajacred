                            ...
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        ...
                                        <form action="<?= base_url('correspondentes/salvar') ?>" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="inscricao" id="inscricao" class="form-control" 
                                                       value="<?= set_value('inscricao') ?>" placeholder="CPF|CNPJ" />
                                                <span class="text-muted">Utilizar CPF se Pessoa Física|CNPJ se Empresa</span>
                                            </div>
                                            <div class="form-group">
                                                <label for="email">E-mail</label>
                                                <input type="email" name="email" id="email" class="form-control" 
                                                       value="<?= set_value('email') ?>" placeholder="E-mail" />
                                                <span class="text-muted">E-mail da Empresa</span>
                                            </div>
                                            <div class="form-group">
                                                <label for="phone">Contato</label>
                                                <input type="tel" name="phone" id="phone" class="form-control" 
                                                       value="<?= set_value('phone') ?>" placeholder="Celular" />
