...
<aside class="main-sidebar sidebar-dark-pink elevation-4">
    ...
    <a href="<?php echo base_url('admin') ?>" class="brand-link">
        <img src="<?php echo base_url('assets/img/logo_ajacred.png') ?>"
    ...
    <div class="sidebar">
        ...
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="<?php echo base_url('assets/img/user2.jpg') ?>" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
            ...
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('cliente/gerenciar/') ?>" class="nav-link">
                                <i class="fas fa-user-plus nav-icon"></i>
                ...
                <li class="nav-item has-treeview">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('contrato/new') ?>" class="nav-link">
                                <i class="fas fa-hand-holding-usd nav-icon"></i>
                                <p>Novo(Teste)</p>
                            </a>
                        </li>
                ...
                <li class="nav-item has-treeview">
                    <a href="#" class="nav-link active"><i class="fas fa-file-invoice-dollar nav-icon"></i>
